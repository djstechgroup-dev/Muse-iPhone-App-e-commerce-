...
//                                                    alpha:0.5f]];
    ...
    _brandnameLabel.font = [UIFont fontWithName:@"GurmukhiMN" size:20.0];
   ...
   //price
    ...
    if (strPrice != nil && [strPrice isKindOfClass:[NSString class]] && ![strPrice isEqualToString:@"<null>"])
    {
        ...
        _discountpriceLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:18.0];
        ...
        if (strPrice != nil && [strPrice isKindOfClass:[NSString class]] && ![strPrice isEqualToString:@"<null>"])
        {
            ...
            _priceLabel.font = [UIFont fontWithName:@"HelveticaNeue-Thin" size:18.0];
    ...
    _nameLabel.font = [UIFont fontWithName:@"Avenir-Light" size:16.0];
    ...
    _descTextView.font = [UIFont fontWithName:@"Avenir-Light" size:15.0];
