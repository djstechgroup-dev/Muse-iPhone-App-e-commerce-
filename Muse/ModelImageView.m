...
- (void) showComponents
{
    ...
    brandnameLabel.font = [UIFont fontWithName:@"GurmukhiMN" size:12.0];
    ...
    nameLabel.font = [UIFont fontWithName:@"Avenir-Light" size:10.0];
    ...
    if (strPrice != nil && [strPrice isKindOfClass:[NSString class]] && ![strPrice isEqualToString:@"<null>"])
    {
        ...
        priceLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:8.0];
        ...
        discountpriceLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:12.0];
        ...
        discountLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:4.0];
        ...
        discountLabel.font = [UIFont fontWithName:@"HelveticaNeue" size:10.0];
        discountLabel.textAlignment = NSTextAlignmentCenter;
        discountLabel.textColor = [UIColor whiteColor];
        [discountRateView addSubview:discountLabel];
    }
